...
function ElderlyInformation() {
  ...
  return (
    <div className="bg-white shadow-lg rounded-2xl overflow-hidden border border-gray-100 flex flex-col">
      ...
      <div className="h-24 bg-gradient-to-r from-blue-600 to-green-500" />
      ...
      <div className="px-6 pb-6 relative">
        ...
        <div className="w-20 h-20 bg-white p-1 rounded-full shadow-md -mt-10 mb-4 flex items-center justify-center mx-auto md:mx-0">
           <div className="w-full h-full rounded-full bg-gray-100 flex items-center justify-center text-blue-600">
        ...
        <h2 className="text-2xl font-bold text-gray-800 text-center md:text-left mb-6">Elderly Information</h2>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center p-3 bg-gray-50 rounded-lg">
            ...
            <span className="text-gray-900 font-semibold">{elderly.age} yrs old</span>
          </div>

          <div className="flex items-center p-3 bg-gray-50 rounded-lg">
            <span className="text-gray-500 w-24 text-sm font-medium">Birthday</span>
            <span className="text-gray-900 font-semibold">
              {elderly.birthday?.toDate().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
            </span>
          </div>
        </div>
      </div>
