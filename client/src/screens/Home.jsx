...
function Home() {
  ...
  return (
    <div>
      <section
        className="w-full relative bg-no-repeat bg-cover h-[80vh] z-0 overflow-hidden"
        style={{
          backgroundImage:
            "url('https://ca-times.brightspotcdn.com/dims4/default/2ba0fff/2147483647/strip/true/crop/6152x4480+0+0/resize/1200x874!/quality/75/?url=https%3A%2F%2Fcalifornia-times-brightspot.s3.amazonaws.com%2F2b%2F1c%2F93168e774efcac36af18d9c02711%2Fla-ca-simu-liu-stock-photo-cropped.jpg')",
        }}
      >
        <div class="relative top-0 left-0 w-full h-full z-10 bg-black/50 flex items-center justify-center flex-col gap-5 ">
          ...
          <button
            type="button"
            class="py-2.5 px-6 text-sm rounded-lg bg-transparent border border-white  text-white cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 hover:bg-white/25 hover:text-white"
          >
            CALL A ACTION
          </button>
        </div>
